...
search.app:
  ...
  - D365CE
---
# <a name="xrmwebapi-client-api-reference"></a>Xrm.WebApi (クライアント API 参照)



Web API を使用してレコードを作成および管理し、モデル駆動型アプリの Web API アクションおよび関数を実行するプロパティとメソッドを提供します。 
...
|[オフライン](xrm-webapi/offline.md)|[!INCLUDE[xrm-webapi/includes/offline-description.md](xrm-webapi/includes/offline-description.md)]|
