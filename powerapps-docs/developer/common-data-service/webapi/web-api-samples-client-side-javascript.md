---
title: Web API データ操作のサンプル (クライアント側の JavaScript) (アプリ用 Common Data Service)| Microsoft Docs
...
アプリ用 Common Data Service Customer Engagement の以前のバージョンを使用している場合は、[Web API のサンプル (クライアント側の JavaScript)](https://msdn.microsoft.com/library/mt770370.aspx) を参照してください。
