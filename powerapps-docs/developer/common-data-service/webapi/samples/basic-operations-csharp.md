---
title: 'Web API 基本操作のサンプル (C#) (アプリ用 Common Data Service) | Microsoft Docs'
description: このサンプルによって、アプリ用 Common Data Service Web API を使用して基本的な CRUD (作成、取得、更新、削除) の実行方法およびアプリ用 Common Data Service エンティティ インスタンス上での関連付けと関連付け解除の操作の実行方法を示します
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
このサンプルによって、アプリ用 Common Data Service Web API を使用して基本的な CRUD (作成、取得、更新、削除) の実行方法およびアプリ用 Common Data Service エンティティ インスタンス上での関連付けと関連付け解除の操作の実行方法を示します。  
  
> [!NOTE]
>  このアプリ用 Common Data Service 操作のサンプルの実装とコンソール出力は「[Web API 基本操作のサンプル](../web-api-basic-operations-sample.md)」で詳しく説明されています。またコモン C# の構成の使用は「[Web API のサンプル (C#)](../web-api-samples-csharp.md)」で説明されています。  
  
<a name="bkmk_prerequisites"></a>
   
## <a name="prerequisites"></a>前提条件

すべてのアプリ用 Common Data Service Web API C# サンプルの前提条件は、親トピック [Web API サンプル (C#)](../web-api-samples-csharp.md) の [前提条件](../web-api-samples-csharp.md#bkmk_prerequisites) セクションで説明されています。  
  
<a name="bkmk_runSample"></a>
  
## <a name="run-this-sample"></a>このサンプルの実行

まず、[Microsoft CRM Web API 基本操作 (C#)](http://go.microsoft.com/fwlink/p/?LinkId=824042) にアクセスして、サンプル アーカイブ ファイル、Microsoft CRM Web API 基本操作のサンプル (CS).zip をダウンロードし、内容をローカル フォルダーに抽出します。 このフォルダには、次のファイルが含まれている必要があります。  
  
|ファイル|目的/説明|  
|----------|--------------------------|  
|Program.cs|このサンプルのプライマリ ソース コードが含まれます。|  
|App.config|プレースホルダーのアプリ用 Common Data Service サーバー接続情報を含むアプリケーション構成ファイルです。|  
|Authentication.cs<br />Configuration.cs<br />Exceptions.cs|フォルダー **Web API ヘルパー コード**に位置し、これらのファイルは [アプリ用 Common Data Service Web API Helper Library (C#) の使用](../use-microsoft-dynamics-365-web-api-helper-library-csharp.md) で説明されている補足ライブラリから成り立ちます。|  
|BasicOperations.sln <br />BasicOperations.csproj <br />Packages.config <br />AssemblyInfo.cs|このサンプルの標準 Visual Studio 2015 ソリューション、プロジェクト、NuGet パッケージ構成、およびアセンブリ情報ファイルです。|  
...
2.  アプリケーション構成ファイル、App.config を編集し、アプリ用 Common Data Service サーバーに接続情報を指定します。  詳細については、「[ヘルパー コード: 構成クラス](../web-api-helper-code-configuration-classes.md)」を参照してください。  
