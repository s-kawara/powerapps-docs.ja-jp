---
title: アプリ用 Common Data Service Web API の使用を開始しましょう (client-side JavaScript) | Microsoft Docs
description: HTML Web リソース、フォーム スクリプトまたはリボン コマンドで JavaScript を使用して、Web API を使った Common Data Service for Appsdata への操作ができます
ms.custom: ''
ms.date: 10/31/2018
ms.reviewer: ''
...
search.app:
  ...
  - D365CE
---
# <a name="get-started-with-the-common-data-service-for-apps-web-api-client-side-javascript"></a>アプリ用 Common Data Service Web API に関する入門情報 (クライアント側 JavaScript)

<!-- TODO: 
> [!NOTE]
> ![This page is under construction. Check back soon!](../../media/under_construction.png "Coming soon") [!INCLUDE[cc-under-construction](../../includes/cc-under-construction.md)] -->

HTML の Web リソース、フォーム スクリプト、リボン コマンドでは、JavaScript を使用して、アプリ用 CDS の導入された Web API を使ったアプリ用 Common Data Service への操作ができます。
...
アプリ用 Common Data Service Customer Engagement の以前のバージョンを使用している場合は、[アプリ用 Microsoft Common Data Service Web API に関する入門情報 (クライアント側の JavaScript)](https://msdn.microsoft.com/library/gg334279.aspx) で使用できる指示に従います。  
