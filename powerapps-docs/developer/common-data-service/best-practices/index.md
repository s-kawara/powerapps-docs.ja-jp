---
title: '開発者: アプリ用 Common Data Service のベスト プラクティスとガイダンス | Microsoft Docs'
description: 開発者のための PowerApps アプリ用 Common Data Service のベスト プラクティスとガイダンスです。
services: ''
suite: powerapps
...
# <a name="best-practices-and-guidance-for-the-common-data-service-for-apps"></a>アプリ用 Common Data Service のベスト プラクティスとガイダンス

アプリ用 Common Data Service (CDS) は、柔軟にカスタマイズして調整したエクスペリエンスを開発者が構築できるようにする拡張可能なフレームワークです。 アプリ用 Common Data Service (CDS) をカスタマイズ、拡張、または統合する場合は、開発者は既存のガイダンスやベスト プラクティスを認識している必要があります。 
...
- CDS データに関する作業
- 既存のアプリ用 Common Data Service の統合
