            ...
            <ul id="home">
               ...
               <li>
                  ...
                  <ul id="maker"
                     ...
                     <li>
                        <div class="container">
                           <p>アプリ作成者は、コードを記述せずにカスタム ビジネス アプリをすばやく作成することによって、組織のミッション クリティカルなデータを管理できます。 PowerApps では次の 2 種類のアプリを作成できます。<strong>キャンバス アプリ</strong>と<strong>モデル駆動型アプリ</strong>です。 <strong>CDS for Apps</strong> は、ビジネス アプリで使用されるデータを安全に格納し、管理することができるデータ プラットフォームです。 詳細情報:<a href="/powerapps/maker">アプリの作成</a>。</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-intro">Common Data Service for Apps とは</a></p>
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/maker/common-data-service/data-platform-powerbi-connector">CDS for Apps データから Power BI レポートを作成する</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/environments-administration">環境の管理</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/database-security">環境セキュリティの構成</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/admin-view-apps">環境内のアプリの表示</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/data-integrator">CDS for Apps にデータを統合する</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/powerapps-gdpr-dsr-guide">データ主体の権利 (DSR) 要求に応答する</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/pricing-billing-skus">ライセンスの概要</a></p>
...
<!--                                   <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/administrator/powerapps-for-us-govt">PowerApps for US Government</a></p> -->
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/admin-guide">管理者 Power プラットフォーム</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/get-help-support">ヘルプとサポートの表示</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/analytics-common-data-service">CDS for Apps の分析</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/power-platform/admin/manage-environments">環境を管理する</a></p>
                                 </div>
                              </div>
                           </div>
                        </div>
               ...
               <li>
                  ...
                  <ul id="developer"
                     ...
                     <li>
                        <div class="container">
                           <p>開発者は、コードを使用して、ビジネス アプリを拡張し、CDS for Apps に接続するクライアント アプリケーションを作成できる<a href="/powerapps/?branch=release-crm-mig-vivek#pivot=home&panel=maker">アプリ作成者</a>です。</p>
                           <hr/>
                           <br/>
                        </div>
                     </li>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/overview">CDS for Apps:開発者向け概要</a></p>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/model-driven-apps/web-resources">Web リソースの使用</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">CDS for Apps データを操作する</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">CDS for Apps メタデータを操作する</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <hr/>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/plug-ins">プラグイン (CDS for Apps)</a></p>
                                    <p><a class="barLink" style="font-size: 0.95rem" href="/powerapps/developer/common-data-service/workflow/workflow-extensions">ワークフローの拡張機能 (CDS for Apps)</a></p>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">CDS for Apps にデータを統合する</h3>
                                    <hr/>
                        ...
                        <div class="cardSize">
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    <h3 style="font-size: 1.15rem">CDS for Apps 用のクライアント アプリケーションを作成する</h3>
                                    <hr/>
                           ...
                           <div class="cardPadding">
                              <div class="card">
                                 ...
                                 <div class="cardText">
                                    ...
                                    <p><a class="barLink" style="font-size: 0.95rem" href="https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/about?view=dynamics-ce-odata-9">Web API リファレンス</a></p>
